...
var marker = new mapboxgl.Marker({color: "darkorange", draggable: true})
    .setLngLat([-98.4861, 29.4260])
    .addTo(map)
...
// geocode("16622 Willow Run St, San Antonio, TX", mapBoxKey).then(function(results){
//     console.log("Hello");
//     console.log(results);
// })


geocode("16622 Willow Run St. San Antonio, Texas", mapBoxKey).then(function(results){
    console.log(results);
